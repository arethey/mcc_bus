<form class="form-inline" method="GET" action="schedule.php">
    ...
    <select class="form-control mb-2 mr-sm-2" id="route_from" name="route_from" value="<?php echo $route_from; ?>">
    ...
    <select class="form-control mb-2 mr-sm-2" id="route_to" name="route_to" value="<?php echo $route_to; ?>">
    ...
    <input type="date" class="form-control mb-2 mr-sm-2" id="schedule_date" name="schedule_date" value="<?php echo $schedule_date; ?>">
