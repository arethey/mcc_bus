    ...
    <div class="wrapper">
        <div class="navigation bg-dark">
            <ul class="nav flex-column">
                <li
                    class="nav-item <?php if((isset($_GET['page']) && $_GET['page'] === 'dashboard') || empty($_GET['page'])) echo 'bg-primary' ?>">
                ...
                <li
                    class="nav-item <?php if(isset($_GET['page']) && $_GET['page'] === 'schedules' || $_GET['page'] === 'scheduleInfo') echo 'bg-primary' ?>">
                    ...
                    <a class="nav-link text-white" href="index.php?page=bus">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" height="32px"
                                viewBox="0 0 20 20" width="32px" fill="#ffff">
                                <g>
        ...
        <div class="main">
            <nav class="navbar navbar-light bg-white justify-content-between">
                <a class="navbar-brand toggle" href="#" onclick="toggleMenu()">
                    ...
                    <span>Bantayan Island Online Bus Reservation</span>
                </a>
                <div>
                    <a class="btn btn-link mr-auto" href="./backend/logout.php">Logout</a>
                </div>
            </nav>
